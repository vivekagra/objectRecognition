...
class YOLO(object):
    ...
    def detect_image(self, color_img, depth_img):
        ...
        if self.model_image_size != (None, None):
            ...
            boxed_image = letterbox_image(color_img, tuple(reversed(self.model_image_size)))
        else:
            new_image_size = (color_img.width - (color_img.width % 32),
                              color_img.height - (color_img.height % 32))
            boxed_image = letterbox_image(color_img, new_image_size)
